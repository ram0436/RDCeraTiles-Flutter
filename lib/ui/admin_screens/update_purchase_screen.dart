...
class UpdatePurchaseScreen extends StatefulWidget {
  const UpdatePurchaseScreen({Key? key}) : super(key: key);
...
class _UpdatePurchaseScreenState extends State<UpdatePurchaseScreen> {
  ...
  GlobalKey<AutoCompleteTextFieldState<String>> productKey = GlobalKey();
            ...
            child: Column(
              ...
              children: [
                ...
                Obx(() {
                  ...
                  return Container(); // Return empty if no models for non-category 2
                }),
                const Text(
                  'Enter Box Count',
                  style: TextStyle(
